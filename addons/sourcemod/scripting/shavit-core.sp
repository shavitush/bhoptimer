...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	...
	CreateNative("Shavit_PauseMovement", Native_PauseMovement);
...
public int Native_PauseMovement(Handle handler, int client)
{
	//return view_as<int>(gCV_PauseMovement);
	return view_as<bool>(gCV_PauseMovement.BoolValue);
}
