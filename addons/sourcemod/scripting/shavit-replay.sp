...
public void OnPluginStart()
{
	...
	gCV_PlaybackPreRunTime = new Convar("shavit_replay_preruntime", "1.0", "Time to record before a player leaves start zone. (The value should NOT be too high)", 0, true, 0.0);
